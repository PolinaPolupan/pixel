...
const ContextMenu = ({
    ...
    const { nodesConfig, nodeTypeDetails, isLoading, error, isReady } = useNodesApi();
    ...
    // We could use isReady from the API, but keeping the explicit checks for clarity
    return (
        <div
            className="context-menu"
            style={{
